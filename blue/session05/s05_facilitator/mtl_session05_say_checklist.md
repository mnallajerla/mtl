...
- [ ] [<img src = "https://github.com/lzim/teampsd/blob/master/resources/icons/done.png" height = "40" width = "40">](#DontClick) Done: We checked to make sure we could log in to the sim UI at mtl.how/test/sim_test.    
...
### 2. Let's now go back to mtl.how/test/data_test_test in your browser window to check the name of our team_data_table file  
- [ ] Guide team lead to mtl.how/test/data_test_test and then to the team_data_table file  
...
- [ ] Open a new browser window in Chrome or Edge and go to mtl.how/test/sim_test  
...
- [ ] For next time, if you can, log in to to the sim UI at mtl.how/test/sim_test.

...
| --- | --- | 
| [<img src = "https://raw.githubusercontent.com/lzim/teampsd/master/resources/logos/mtl_how_sim.png" height = "75" width = "110">](http://mtl.how/test/sim_test) We checked to make sure we could log in to the simulation user interface (sim UI) at mtl.how/test/sim_test. [![](https://raw.githubusercontent.com/lzim/teampsd/master/resources/gifs/mtl_2.0/sim_ui_1.gif)](#DontLink) **_MTL_ 2.0. For _MTL_ 1.7, click [here](https://github.com/lzim/mtl/blob/master/release_1.7/mtl_session05_see.md)**  | [<img src = "https://raw.githubusercontent.com/lzim/teampsd/master/resources/logos/mtl_how_sim.png" height = "75" width = "110">](http://mtl.how/test/sim_test) We will upload our team data table to the sim UI and review our data in the Experiments section. [![](https://raw.githubusercontent.com/lzim/teampsd/master/resources/gifs/mtl_2.0/sim_ui_sections.gif)](#DontLink) **_MTL_ 2.0. For _MTL_ 1.7, click [here](https://github.com/lzim/mtl/blob/master/release_1.7/mtl_session05_see.md)**| 
...
2. Let's now go back to mtl.how/test/data_test_test in any browser window to check the name of our team data file.
...
4. Log in to the sim UI.
    ...
    + Open a new browser window in Google Chrome and go to mtl.how/test/sim_test.
...
#### New for _MTL_ 2.0
   ...
   + For CC & MM, you need to select your Learning Mode before hitting Play.  
       + Refer to the Care Coordination (CCParams) or Medication Management (MMParams) tab of the Team Data Table at mtl.how/test/data_test_test, for data regarding the team's New Patient Start Rates and Return-to-Clinic Intervals.

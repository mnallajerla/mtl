...
In the Session 1 Done and Do table, you can see that for today, we joined the Microsoft Teams meeting invitation from Outlook and called in, if needed. Your home base is mtl.how/test for ALL of the tools and resources we'll use in _Modeling to Learn_, so if you ever forget a link or anything, just type mtl.how/test into your browser.
...
- Furthermore, let's decide on a Team Lead. The role of the Team Lead is to:
  ...
  2. become familiar with *MTL* resources and help team members trouble-shoot - mainly Microsoft Teams (used for screen-sharing during meetings), mtl.how/test/data_test_test (the data user interface), mtl.how/test/sim_test (the simulation user interface); and
...
3. Before our next meeting, check to see if you can see your team folder at mtl.how/test/data_test_test. 
   - First, go to any browser and type in mtl.how/test/data_test_test in the top search bar. Then, select your VISN and then your facility. 
